...
class Dataset(Dataset):
    ...
    def __init__(self, folder, image_size, exts=['jpg', 'jpeg', 'png', 'tiff'], augment_horizontal_flip=False, convert_image_to=None):
        ...
        self.transform = T.Compose([T.Lambda(maybe_convert_fn), T.Resize(image_size), (T.RandomHorizontalFlip() if augment_horizontal_flip else nn.Identity()), T.CenterCrop(image_size), T.ToTensor()])
